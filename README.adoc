...
:project_id: CPSC4125_Spring_Boot_Webapp
...
Downloaded from https://github.com/spring-guides/gs-spring-boot
...
can also use Gradle. It also shows values of `com.example` and `spring-boot` as the Group
